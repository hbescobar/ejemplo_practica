                            ...
                            <div class="carousel-item">
                                <form id="formPaso2" action="<?= getUrl('reservas', 'reservas', 'postInsert'); ?>" method="POST" class="needs-validation" novalidate>
                                    ...
                                    <div class="row g-3 mb-3">
                                        ...
                                        <div class="col-md-3">
                                            <label for="reserva_fecha_inicio" class="form-label"><i class="bx bx-time"></i> Hora Inicio <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-3">
                                            <label for="reserva_fecha_fin" class="form-label"><i class="bx bx-time-five"></i> Hora Fin <span class="text-danger">*</span></label>
