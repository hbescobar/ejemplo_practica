    ...
    <div class="container py-5">
        <div class="p-5 rounded shadow-lg" style="background: linear-gradient(135deg, rgb(255, 255, 255), rgb(234, 238, 234)); 
            ...
            <h1 class="text-center mb-4">
                <i class="fas fa-edit" style="color:rgb(73, 110, 51);"></i> Detalle  reserva
            </h1>
            ...
            <input type="hidden" name="id_reserva" value="<?= $reserva['reserva_id']; ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control rounded-pill" value="<?php echo $reserva['reserva_fecha_solicitud']; ?>" readonly>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control rounded-pill" name="fecha_devolucion" readonly value="<?php echo $reserva['reserva_fecha_devolucion']; ?>" required>
                </div>
                <div class="form-group">
                    <label>Observaciones:</label>
                    <textarea id="observaciones" name="observaciones"  readonly class="form-control rounded" rows="4" placeholder="Escribe tus comentarios aquí..."><?php echo $reserva['reserva_observaciones']; ?></textarea>
                </div>
                <div class="text-center mt-4">
                    <a href="<?= getUrl('Reservas', 'Reservas', 'consult'); ?>" class="btn btn-primary rounded-pill shadow-sm px-5 py-2">
