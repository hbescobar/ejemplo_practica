...
<body>
    <div class="container-fluid min-vh-100 d-flex justify-content-center align-items-center">
        <div class="p-5 rounded shadow-lg" style="background: linear-gradient(135deg, rgb(255, 255, 255), rgb(234, 238, 234)); 
            ...
            <h1 class="text-center mb-4">
                <i class="fas fa-edit" style="color:rgb(73, 110, 51);"></i> Actualizar préstamo
            </h1>
            ...
            <input type="hidden" name="id_prestamo" value="<?= $prestamo['id_prestamo']; ?>">
                ...
                <div class="form-group">
                    ...
                    <textarea id="observaciones" name="observaciones" class="form-control rounded" rows="4" placeholder="Escribe tus comentarios aquí..."><?php echo $prestamo['observaciones']; ?></textarea>
                </div>
                ...
                <div class="text-center mt-4">
                    ...
                    <a href="<?= getUrl('Prestamos', 'Prestamos', 'consult'); ?>" class="btn btn-danger rounded-pill shadow-sm px-5 py-2">
            ...
            <div class="modal fade" id="adicionarModal" tabindex="-1" aria-labelledby="adicionarModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="<?= getUrl('Prestamos', 'Prestamos', 'adicionar'); ?>" method="POST">
                            <div class="modal-header">
                                <h5 class="modal-title" id="adicionarModalLabel">Adicionar préstamo</h5>
    ...
    <script>
        ...
        $('#adicionarModal button[type="submit"]').click(function (event) {
            ...
            const idPrestamo = $('input[name="id_prestamo"]').val(); 
            ...
            const url = `<?= getUrl('Prestamos', 'Prestamos', 'adicionar') ?>&id_prestamo=${idPrestamo}&` +
