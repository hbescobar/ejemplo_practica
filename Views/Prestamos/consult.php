        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
                ...
                <div class="d-flex gap-2">
                    <a href="<?= getUrl('prestamos', 'prestamos', 'getInsert'); ?>" class="btn btn-success">
                        <i class='bx bx-plus'></i> Registrar Nuevo Préstamo
                    </a>
                    <!-- Botón para exportar a Excel -->
                    <button id="btnExportarExcelPrestamos" class="btn btn-outline-success" type="button">
