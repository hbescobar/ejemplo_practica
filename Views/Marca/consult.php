    ...
    <div class="card shadow border-0">
        <div class="card-body">
            <h4 class="fw-bold text-primary text-center mb-4">
                <i class='bx bx-label'></i> Listado de Marcas
            </h4>
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
                ...
                <div class="input-group" style="max-width: 300px;">
                    ...
                    <input type="search" id="buscadorMarcas" class="form-control" placeholder="Buscar..." aria-label="Buscar">
                </div>

                <a href="<?= getUrl('Marca', 'Marca', 'getInsert'); ?>" class="btn btn-success">
                    <i class='bx bx-plus-circle'></i> Registrar Nueva Marca
                </a>
            </div>

            <!-- Tabla -->
            <div class="table-responsive">
                <table class="table table-bordered table-hover align-middle text-center" id="tablaMarcas">
                        ...
                        <?php if (!empty($marcas)) : ?>
                            <?php foreach ($marcas as $marca) : ?>
                                <tr>
                                    ...
                                    <td><?= htmlspecialchars($marca['marca_nombre']) ?></td>
                                    <td><?= htmlspecialchars($marca['marca_descripcion']) ?></td>
                                    <td>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        const inputBusqueda = document.getElementById('buscadorMarcas');
        const filtroTipo = document.getElementById('filtroTipo');
        const tabla = document.getElementById('tablaMarcas').getElementsByTagName('tbody')[0];
